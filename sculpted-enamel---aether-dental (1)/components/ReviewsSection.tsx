...
const reviews = [
  {
    ...
    content: 'Aether Dental transformed my smile completely. The team\'s attention to detail and use of cutting-edge technology made the entire experience exceptional.',
    rating: 5,
  },
  {
    name: 'James Chen',
    role: 'Software Engineer',
    content: 'The AI booking system is incredibly convenient. I was skeptical at first, but the personalized care I received exceeded all my expectations.',
    rating: 5,
  },
  {
    name: 'Emily Rodriguez',
    role: 'Interior Designer',
    content: 'Finally, a dental practice that combines artistry with precision. My veneers look absolutely natural. Highly recommend their cosmetic services.',
    rating: 5,
  },
];
  ...
  return (
    <section id="reviews" className="bg-[#fafafa] py-24 px-6 md:px-12 overflow-hidden">
      <style>{`
        ...
        .dot-border {
          background-image:
            radial-gradient(circle, rgba(0, 229, 255, 0.5) 1px, transparent 1px);
