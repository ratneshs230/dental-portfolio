...
const services = [
  {
    ...
    description: 'Transform your smile with veneers, whitening, and aesthetic enhancements tailored to your unique features.',
    borderColor: 'from-cyan-400 via-blue-500 to-purple-500',
  },
  {
    icon: '02',
    title: 'Orthodontics',
    description: 'Invisible aligners and modern braces for perfect alignment. Precision technology meets comfort.',
    borderColor: 'from-emerald-400 via-cyan-500 to-blue-500',
  },
  {
    icon: '03',
    title: 'Dental Implants',
    description: 'Permanent solutions that look and feel natural. Restore your confidence with state-of-the-art implants.',
    borderColor: 'from-orange-400 via-pink-500 to-purple-500',
  },
  {
    icon: '04',
    title: 'Preventive Care',
    description: 'Comprehensive cleanings, examinations, and early detection to maintain your optimal oral health.',
