...
export function generateDentalSchema(clinicInfo) {
  return {
    ...
    description: 'Professional dental clinic in Shahdara, Delhi offering comprehensive dental care services.',
    url: typeof window !== 'undefined' ? window.location.origin : '',
    telephone: '+91-11-24189358',
    email: 'info@drsethisdentalclinic@gmail.com',
    address: {
      '@type': 'PostalAddress',
...
export function generateMetaTags(pageInfo) {
  ...
  return {
    ...
    openGraph: {
      ...
      url,
      images: [{ url: image }],
      siteName: 'Dr. Sethi's Dental Clinic'
    },
    twitter: {
...
export const locationKeywords = [
  'dentist Shahdara',
  'dental clinic Shahdara',
  'best dentist in Shahdara',
  'dentist near me Shahdara',
  'teeth cleaning Shahdara',
  'root canal Shahdara',
  'teeth whitening Shahdara',
  'dental clinic delhi',
  'best dental clinic Shahdara delhi',
  'affordable dentist Shahdara'
]
