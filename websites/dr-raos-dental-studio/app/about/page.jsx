...
const stats = [
  { icon: Calendar, label: 'Years Experience', value: '21+' },
  { icon: Users, label: 'Happy Patients', value: '1K+' },
  { icon: Award, label: 'Dentists', value: '1' },
  { icon: Heart, label: 'Treatments Done', value: '5568+' },
]
      ...
      <div className="dental-container">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-display font-bold text-dental-foreground mb-6">
            About Dr. Rao's Dental Studio
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Providing exceptional dental care to Shalimar Bagh since 2015.
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Dr. Rao's Dental Studio was established with a simple mission: to provide
            ...
            <p className="text-gray-600 mb-6">
              ...
              6 support staff are committed to making every visit comfortable
              and stress-free.
            </p>
