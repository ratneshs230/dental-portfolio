...
export function generateDentalSchema(clinicInfo) {
  return {
    ...
    description: 'Professional dental clinic in Hauz Khas, Delhi offering comprehensive dental care services.',
    url: typeof window !== 'undefined' ? window.location.origin : '',
    telephone: '+91-11-27595323',
    email: 'info@drmittalsdentalstudio@gmail.com',
    address: {
      '@type': 'PostalAddress',
...
export function generateMetaTags(pageInfo) {
  ...
  return {
    ...
    openGraph: {
      ...
      url,
      images: [{ url: image }],
      siteName: 'Dr. Mittal's Dental Studio'
    },
    twitter: {
...
export const locationKeywords = [
  'dentist Hauz Khas',
  'dental clinic Hauz Khas',
  'best dentist in Hauz Khas',
  'dentist near me Hauz Khas',
  'teeth cleaning Hauz Khas',
  'root canal Hauz Khas',
  'teeth whitening Hauz Khas',
  'dental clinic delhi',
  'best dental clinic Hauz Khas delhi',
  'affordable dentist Hauz Khas'
]
