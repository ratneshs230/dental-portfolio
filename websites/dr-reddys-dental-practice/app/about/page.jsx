...
const stats = [
  { icon: Calendar, label: 'Years Experience', value: '23+' },
  { icon: Users, label: 'Happy Patients', value: '3K+' },
  { icon: Award, label: 'Dentists', value: '2' },
  { icon: Heart, label: 'Treatments Done', value: '2256+' },
]
      ...
      <div className="dental-container">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-display font-bold text-dental-foreground mb-6">
            About Dr. Reddy's Dental Practice
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Providing exceptional dental care to Laxmi Nagar since 2001.
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Dr. Reddy's Dental Practice was established with a simple mission: to provide
              world-class dental care in a warm, welcoming environment. Located in the
              heart of Laxmi Nagar, we've been serving families for over
              23 years.
            </p>
            <p className="text-gray-600 mb-6">
              Our team of 2 experienced dentists and
              4 support staff are committed to making every visit comfortable
              and stress-free.
            </p>
