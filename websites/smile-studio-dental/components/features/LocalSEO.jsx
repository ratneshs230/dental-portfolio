...
export function DentalSchema() {
  const schema = {
    ...
    description: 'Professional dental clinic in Greater Kailash, Delhi',
    ...
    geo: {
      '@type': 'GeoCoordinates',
      latitude: 28.441019582288003,
      longitude: 77.21332888405111
    },
...
export function LocationBadge() {
  return (
    <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-dental-primary/10 rounded-full text-dental-primary text-sm">
      ...
      <span>Greater Kailash, Delhi</span>
    </div>
  )
}
...
export function GoogleMapsEmbed() {
  const lat = 28.441019582288003
  const lng = 77.21332888405111
