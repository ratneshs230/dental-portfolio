...
export function VoiceAssistant() {
  ...
  const handleVoiceCommand = (command) => {
    ...
    if (lowerCommand.includes('book') || lowerCommand.includes('appointment')) {
      ...
      responseText = 'Connecting you to Dr. Manish Kapoor's Dental Clinic. Please hold while I dial the clinic number.'
      setTimeout(() => {
        window.location.href = 'tel:+91-11-28423032'
      }, 2000)
      ...
      responseText = 'We are located at 391, Patel Nagar, New Delhi - 11046. Would you like me to open directions in Google Maps?'
      ...
      responseText = 'For dental emergencies, please call us immediately at +91-11-28423032. We prioritize emergency cases.'
    } else {
