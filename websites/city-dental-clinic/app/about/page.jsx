...
const stats = [
  ...
  { icon: Heart, label: 'Treatments Done', value: '5760+' },
]
      ...
      <div className="dental-container">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Providing exceptional dental care to Dwarka since 2014.
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              City Dental Clinic was established with a simple mission: to provide
              world-class dental care in a warm, welcoming environment. Located in the
              heart of Dwarka, we've been serving families for over
              27 years.
            </p>
