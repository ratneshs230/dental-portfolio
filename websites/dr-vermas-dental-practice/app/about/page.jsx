...
const stats = [
  { icon: Calendar, label: 'Years Experience', value: '14+' },
  { icon: Users, label: 'Happy Patients', value: '2K+' },
  { icon: Award, label: 'Dentists', value: '4' },
  { icon: Heart, label: 'Treatments Done', value: '5160+' },
]
      ...
      <div className="dental-container">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-display font-bold text-dental-foreground mb-6">
            About Dr. Verma's Dental Practice
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Providing exceptional dental care to Defence Colony since 2019.
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Dr. Verma's Dental Practice was established with a simple mission: to provide
              world-class dental care in a warm, welcoming environment. Located in the
              heart of Defence Colony, we've been serving families for over
              14 years.
            </p>
