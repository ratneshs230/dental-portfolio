...
const stats = [
  ...
  { icon: Heart, label: 'Treatments Done', value: '3264+' },
]
      ...
      <div className="dental-container">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-display font-bold text-dental-foreground mb-6">
            About Smile Dental Studio
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Providing exceptional dental care to Rajendra Nagar since 2009.
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Smile Dental Studio was established with a simple mission: to provide
              world-class dental care in a warm, welcoming environment. Located in the
              heart of Rajendra Nagar, we've been serving families for over
              26 years.
            </p>
          ...
          >
            ...
            <div className="relative dental-card">
              ...
              <ul className="space-y-2 text-gray-600">
                <li>• Modern 1-chair dental setup</li>
