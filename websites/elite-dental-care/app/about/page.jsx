...
const stats = [
  ...
  { icon: Heart, label: 'Treatments Done', value: '2436+' },
]
      ...
      <div className="dental-container">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Providing exceptional dental care to Model Town since 2009.
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Elite Dental Care was established with a simple mission: to provide
