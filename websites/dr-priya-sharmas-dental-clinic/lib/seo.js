...
export function generateDentalSchema(clinicInfo) {
  return {
    ...
    description: 'Professional dental clinic in Janakpuri, Delhi offering comprehensive dental care services.',
    url: typeof window !== 'undefined' ? window.location.origin : '',
    telephone: '+91-11-35793955',
    email: 'info@drpriyasharmasdentalclinic@gmail.com',
    address: {
      '@type': 'PostalAddress',
      streetAddress: '646, Janakpuri, New Delhi - 11067',
    ...
    geo: {
      '@type': 'GeoCoordinates',
      latitude: 28.51323481284117,
      longitude: 77.34764195015264
    },
...
export function generateMetaTags(pageInfo) {
  ...
  return {
    ...
    openGraph: {
      ...
      url,
      images: [{ url: image }],
      siteName: 'Dr. Priya Sharma's Dental Clinic'
    },
    twitter: {
...
export const locationKeywords = [
  'dentist Janakpuri',
  'dental clinic Janakpuri',
  'best dentist in Janakpuri',
  'dentist near me Janakpuri',
  'teeth cleaning Janakpuri',
  'root canal Janakpuri',
  'teeth whitening Janakpuri',
  'dental clinic delhi',
  'best dental clinic Janakpuri delhi',
  'affordable dentist Janakpuri'
]
