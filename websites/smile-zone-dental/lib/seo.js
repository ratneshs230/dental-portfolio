...
export function generateDentalSchema(clinicInfo) {
  return {
    ...
    description: 'Professional dental clinic in Nehru Place, Delhi offering comprehensive dental care services.',
...
export const locationKeywords = [
  'dentist Nehru Place',
  'dental clinic Nehru Place',
  'best dentist in Nehru Place',
  'dentist near me Nehru Place',
  'teeth cleaning Nehru Place',
  'root canal Nehru Place',
  'teeth whitening Nehru Place',
  'dental clinic delhi',
  'best dental clinic Nehru Place delhi',
  'affordable dentist Nehru Place'
]
