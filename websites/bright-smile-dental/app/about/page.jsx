...
const stats = [
  ...
  { icon: Heart, label: 'Treatments Done', value: '732+' },
]
      ...
      <div className="dental-container">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Providing exceptional dental care to Vasant Kunj since 2009.
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Bright Smile Dental was established with a simple mission: to provide
              world-class dental care in a warm, welcoming environment. Located in the
              heart of Vasant Kunj, we've been serving families for over
              26 years.
            </p>
