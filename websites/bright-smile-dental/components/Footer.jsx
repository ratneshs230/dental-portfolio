        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Providing quality dental care in Vasant Kunj for over 26 years.
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-400">429, Vasant Kunj, New Delhi - 11075</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-dental-primary" />
                <a href="tel:+91-11-29237755" className="text-gray-400 hover:text-white transition-colors">
                  +91-11-29237755
                </a>
              </li>
              <li className="flex items-center gap-3">
