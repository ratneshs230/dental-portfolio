...
const services = [
  ...
  },
  {
    ...
    description: 'Replace missing teeth with natural-looking bridges for a complete smile.',
    borderColor: 'from-emerald-400 via-cyan-500 to-blue-500'
  },
  {
    icon: '03',
    title: 'Pediatric Dentistry',
    description: 'Gentle dental care for children in a friendly, comfortable environment.',
