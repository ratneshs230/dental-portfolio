...
export function DentalSchema() {
  const schema = {
    ...
    description: 'Professional dental clinic in Rajendra Nagar, Delhi',
    ...
    geo: {
      '@type': 'GeoCoordinates',
      latitude: 28.56640368743731,
      longitude: 77.03198889511636
    },
...
export function LocationBadge() {
  return (
    <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-dental-primary/10 rounded-full text-dental-primary text-sm">
      ...
      <span>Rajendra Nagar, Delhi</span>
    </div>
  )
}
...
export function GoogleMapsEmbed() {
  const lat = 28.56640368743731
  const lng = 77.03198889511636
