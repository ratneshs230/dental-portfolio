    ...
    <section id="contact" className="bg-[#0a0a0a] py-24 px-6 md:px-12 relative overflow-hidden">
      <style>{`
        ...
        .corner-dots::before {
          ...
          left: -3px;
          box-shadow:
            calc(100% + 0px) 0 0 0 rgba(0, 229, 255, 0.5);
        }
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <p className="text-gray-400 text-lg leading-relaxed mb-12">
              Ready to transform your smile? Contact Dr. Valecha's Multispeciality Dental Clinic & Implant Center today to schedule your consultation or speak with our AI assistant for immediate assistance.
            </p>

            {/* Contact Info with animated borders */}
            <div className="space-y-6">
              <div className="flex items-start gap-4 group">
                <div className="info-icon-border w-12 h-12 rounded-full border border-gray-700 flex items-center justify-center text-gray-400 group-hover:text-cyan-400 group-hover:border-cyan-500/50 transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-gray-500">Plot No-3, F Block Pocket 24, Sector 3, Rohini (Near LG Showroom, Near Saint Giri School)<br />Rohini Sector 3, Delhi 110085</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-gray-500">+91 11-XXXX XXXX</p>
                </div>
              </div>
          ...
          <div className="contact-card corner-dots bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-10 md:p-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <button
                onClick={openVoice}
                className="w-full mb-8 group relative px-8 py-4 bg-white text-black rounded-full overflow-hidden transition-all hover:shadow-lg hover:shadow-cyan-500/30"
              ...
              <form className="space-y-4">
                ...
                <button
                  type="submit"
                  className="dashed-border w-full py-4 bg-transparent text-white rounded-3xl hover:bg-cyan-500/10 hover:text-cyan-400 transition-all duration-300 font-medium tracking-wide"
                >
                  Send Message
                </button>
              </form>
        ...
        <div className="mt-20 pt-8 border-t border-gray-800 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-600 text-sm">
            © 2024 Dr. Valecha's Multispeciality Dental Clinic & Implant Center. All rights reserved.
          </p>
          <div className="flex gap-6">
            ...
            <a href="#" className="text-gray-500 hover:text-cyan-400 transition-colors text-sm">Instagram</a>
          </div>
        </div>
      </div>
    </section>
