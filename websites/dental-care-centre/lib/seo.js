...
export function generateDentalSchema(clinicInfo) {
  return {
    ...
    description: 'Professional dental clinic in Preet Vihar, Delhi offering comprehensive dental care services.',
    ...
    geo: {
      '@type': 'GeoCoordinates',
      latitude: 28.702778266379443,
      longitude: 77.12731707480853
    },
...
export const locationKeywords = [
  'dentist Preet Vihar',
  'dental clinic Preet Vihar',
  'best dentist in Preet Vihar',
  'dentist near me Preet Vihar',
  'teeth cleaning Preet Vihar',
  'root canal Preet Vihar',
  'teeth whitening Preet Vihar',
  'dental clinic delhi',
  'best dental clinic Preet Vihar delhi',
  'affordable dentist Preet Vihar'
]
