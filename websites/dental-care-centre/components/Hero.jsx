          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-lg">
                Welcome to Dental Care Centre. Experience exceptional dental care
                in Preet Vihar with our team of expert dentists.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href="tel:+91-11-34600047" className="dental-btn-secondary">
              ...
              <div className="aspect-square rounded-3xl bg-dental-gradient p-1">
                <div className="w-full h-full rounded-3xl bg-white flex items-center justify-center">
                  <div className="text-center p-8">
                    ...
                    <div className="text-gray-500">Preet Vihar, Delhi</div>
                    <div class="flex items-center justify-center gap-1 mt-4">
                      <Star className="w-5 h-5 fill-yellow-400 text-yellow-400" />
                      <span class="font-semibold">4.5</span>
                      <span class="text-gray-500">(183 reviews)</span>
                    </div>
                  </div>
                </div>
              </div>
