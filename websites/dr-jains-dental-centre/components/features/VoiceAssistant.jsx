...
export function VoiceAssistant() {
  ...
  const handleVoiceCommand = (command) => {
    ...
    if (lowerCommand.includes('book') || lowerCommand.includes('appointment')) {
      ...
      responseText = 'Connecting you to Dr. Jain's Dental Centre. Please hold while I dial the clinic number.'
      setTimeout(() => {
        window.location.href = 'tel:+91-11-30756416'
      }, 2000)
      ...
      responseText = 'We are located at 714, Paschim Vihar, New Delhi - 11055. Would you like me to open directions in Google Maps?'
      ...
      responseText = 'For dental emergencies, please call us immediately at +91-11-30756416. We prioritize emergency cases.'
    } else {
