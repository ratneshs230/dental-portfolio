...
const stats = [
  ...
  { icon: Award, label: 'Dentists', value: '4' },
  { icon: Heart, label: 'Treatments Done', value: '1392+' },
]
      ...
      <div className="dental-container">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-display font-bold text-dental-foreground mb-6">
            About Dr. Rahul Agarwal's Dental Clinic
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Providing exceptional dental care to Tilak Nagar since 1998.
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Dr. Rahul Agarwal's Dental Clinic was established with a simple mission: to provide
              world-class dental care in a warm, welcoming environment. Located in the
              heart of Tilak Nagar, we've been serving families for over
              23 years.
            </p>
            <p className="text-gray-600 mb-6">
              Our team of 4 experienced dentists and
              7 support staff are committed to making every visit comfortable
              and stress-free.
            </p>
