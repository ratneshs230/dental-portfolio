    ...
    <section id="services" className="bg-white py-24 px-6 md:px-12">
      <style>{`
        ...
        .service-card::before {
          ...
          padding: 2px;
          background: linear-gradient(135deg, transparent 40%, 20, 184, 166,0.3) 50%, transparent 60%);
        ...
        .corner-accents::after {
          ...
          border-radius: 1.5rem;
          background:
            linear-gradient(135deg, 20, 184, 166,0.5) 0%, transparent 20%) top left,
            linear-gradient(-135deg, 20, 184, 166,0.5) 0%, transparent 20%) top right,
            linear-gradient(45deg, 20, 184, 166,0.5) 0%, transparent 20%) bottom left,
            linear-gradient(-45deg, 20, 184, 166,0.5) 0%, transparent 20%) bottom right;
