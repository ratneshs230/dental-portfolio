...
export function VoiceAssistant() {
  ...
  const handleVoiceCommand = (command) => {
    ...
    if (lowerCommand.includes('book') || lowerCommand.includes('appointment')) {
      ...
      responseText = 'Connecting you to Dr. Rahul Agarwal's Dental Clinic. Please hold while I dial the clinic number.'
      setTimeout(() => {
        window.location.href = 'tel:+91-11-30698259'
      }, 2000)
      ...
      responseText = 'We are located at 457, Greater Kailash, New Delhi - 11088. Would you like me to open directions in Google Maps?'
      ...
      responseText = 'For dental emergencies, please call us immediately at +91-11-30698259. We prioritize emergency cases.'
    } else {
