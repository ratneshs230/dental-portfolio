...
export function generateDentalSchema(clinicInfo) {
  return {
    ...
    description: 'Professional dental clinic in Tilak Nagar, Delhi offering comprehensive dental care services.',
    url: typeof window !== 'undefined' ? window.location.origin : '',
    telephone: '+91-11-26264534',
    email: 'info@drrahulagarwalsdentalclinic@gmail.com',
    address: {
      '@type': 'PostalAddress',
...
export function generateMetaTags(pageInfo) {
  ...
  return {
    ...
    openGraph: {
      ...
      url,
      images: [{ url: image }],
      siteName: 'Dr. Rahul Agarwal's Dental Clinic'
    },
    twitter: {
...
export const locationKeywords = [
  'dentist Tilak Nagar',
  'dental clinic Tilak Nagar',
  'best dentist in Tilak Nagar',
  'dentist near me Tilak Nagar',
  'teeth cleaning Tilak Nagar',
  'root canal Tilak Nagar',
  'teeth whitening Tilak Nagar',
  'dental clinic delhi',
  'best dental clinic Tilak Nagar delhi',
  'affordable dentist Tilak Nagar'
]
