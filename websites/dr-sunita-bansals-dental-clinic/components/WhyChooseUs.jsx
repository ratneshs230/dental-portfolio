...
const reasons = [
  ...
  },
  {
    icon: Users,
    title: 'Expert Team',
    description: '3 qualified dentists with specialized training'
  },
  {
    icon: Sparkles,
      ...
      <div className="dental-container px-4">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Discover what makes Dr. Sunita Bansal's Dental Clinic the preferred choice for dental care in Malviya Nagar.
          </p>
        </motion.div>
