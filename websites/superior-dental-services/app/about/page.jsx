...
const stats = [
  { icon: Calendar, label: 'Years Experience', value: '26+' },
  { icon: Users, label: 'Happy Patients', value: '3K+' },
  { icon: Award, label: 'Dentists', value: '1' },
  { icon: Heart, label: 'Treatments Done', value: '5928+' },
]
      ...
      <div className="dental-container">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-display font-bold text-dental-foreground mb-6">
            About Superior Dental Services
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Providing exceptional dental care to Connaught Place since 2011.
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Superior Dental Services was established with a simple mission: to provide
              world-class dental care in a warm, welcoming environment. Located in the
              heart of Connaught Place, we've been serving families for over
              26 years.
            </p>
            <p className="text-gray-600 mb-6">
              Our team of 1 experienced dentist and
              3 support staff are committed to making every visit comfortable
              and stress-free.
            </p>
