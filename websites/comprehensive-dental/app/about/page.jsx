...
const stats = [
  ...
  { icon: Heart, label: 'Treatments Done', value: '1080+' },
]
      ...
      <div className="dental-container">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Providing exceptional dental care to Green Park since 2005.
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Comprehensive Dental was established with a simple mission: to provide
