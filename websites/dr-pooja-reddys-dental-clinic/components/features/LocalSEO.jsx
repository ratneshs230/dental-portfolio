...
export function DentalSchema() {
  const schema = {
    ...
    description: 'Professional dental clinic in Paschim Vihar, Delhi',
    telephone: '+91-11-40900387',
    address: {
      '@type': 'PostalAddress',
      streetAddress: '834, Paschim Vihar, New Delhi - 11032',
    ...
    geo: {
      '@type': 'GeoCoordinates',
      latitude: 28.46817518726131,
      longitude: 77.27803657815112
    },
...
export function GoogleMapsEmbed() {
  const lat = 28.46817518726131
  const lng = 77.27803657815112
