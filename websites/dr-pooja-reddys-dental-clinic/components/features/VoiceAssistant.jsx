...
export function VoiceAssistant() {
  ...
  const handleVoiceCommand = (command) => {
    ...
    if (lowerCommand.includes('book') || lowerCommand.includes('appointment')) {
      ...
      responseText = 'Connecting you to Dr. Pooja Reddy's Dental Clinic. Please hold while I dial the clinic number.'
      setTimeout(() => {
        window.location.href = 'tel:+91-11-40900387'
      }, 2000)
      ...
      responseText = 'We are located at 834, Paschim Vihar, New Delhi - 11032. Would you like me to open directions in Google Maps?'
      ...
      responseText = 'For dental emergencies, please call us immediately at +91-11-40900387. We prioritize emergency cases.'
    } else {
