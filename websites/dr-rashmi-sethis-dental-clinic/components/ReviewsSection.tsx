...
const reviews = [
  {
    name: 'Amit Patel',
    role: 'Entrepreneur',
    content: 'Outstanding service! Dr. Rashmi Sethi's Dental Clinic uses latest technology and the team is highly skilled. My smile has never looked better.',
    rating: 5
  },
  {
    name: 'Meera Reddy',
    role: 'Healthcare Worker',
    content: 'As a healthcare professional, I appreciate their attention to hygiene and patient care. Truly exceptional dental practice.',
    rating: 5
  },
  {
    name: 'Vikram Singh',
    role: 'Engineer',
    content: 'Got my root canal done here without any pain. The doctor is very experienced and makes you feel comfortable.',
    rating: 5
  }
];
  ...
  return (
    <section id="reviews" className="bg-[#fafafa] py-24 px-6 md:px-12 overflow-hidden">
      <style>{`
        @keyframes borderGlow {
          0%, 100% {
            box-shadow:
              ...
              inset 0 0 20px rgba(132, 204, 22, 0.05);
          }
          50% {
            box-shadow:
              0 0 40px rgba(132, 204, 22, 0.2),
              inset 0 0 30px rgba(132, 204, 22, 0.1);
          }
        }
        ...
        .dot-border {
          background-image:
            radial-gradient(circle, rgba(132, 204, 22, 0.5) 1px, transparent 1px);
        ...
        <div className="relative">
          ...
          <div className="review-card-wrapper max-w-4xl mx-auto">
            <div className="review-card-inner p-10 md:p-14">
              {/* Quote Icon */}
              <svg className="w-12 h-12 text-lime-200 mb-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {reviews.map((_, index) => (
                    <button
                      ...
                      className={`w-3 h-3 rounded-full transition-all duration-300 ${
                        index === activeIndex
                          ? 'bg-lime-500 w-8 shadow-lg shadow-lime-500/50'
