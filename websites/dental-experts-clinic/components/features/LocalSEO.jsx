...
export function DentalSchema() {
  const schema = {
    ...
    description: 'Professional dental clinic in South Extension, Delhi',
    ...
    geo: {
      '@type': 'GeoCoordinates',
      latitude: 28.632643236621355,
      longitude: 77.08428507874154
    },
...
export function LocationBadge() {
  return (
    <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-dental-primary/10 rounded-full text-dental-primary text-sm">
      ...
      <span>South Extension, Delhi</span>
    </div>
  )
}
...
export function GoogleMapsEmbed() {
  const lat = 28.632643236621355
  const lng = 77.08428507874154
