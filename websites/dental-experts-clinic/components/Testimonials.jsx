...
const testimonials = [
  ...
  },
  {
    name: 'Rahul M.',
    rating: 5,
    text: 'Best dental clinic in South Extension. Minimal waiting and professional staff. Will definitely come back!',
    service: 'Teeth Cleaning'
  },
  {
    name: 'Anjali K.',
    rating: 5,
    text: 'Very good results with my kids. The doctor explained everything clearly. Great experience!',
