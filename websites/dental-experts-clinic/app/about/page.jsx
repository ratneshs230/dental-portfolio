...
const stats = [
  ...
  { icon: Users, label: 'Happy Patients', value: '0K+' },
  { icon: Award, label: 'Dentists', value: '1' },
  { icon: Heart, label: 'Treatments Done', value: '696+' },
]
      ...
      <div className="dental-container">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-display font-bold text-dental-foreground mb-6">
            About Dental Experts Clinic
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Providing exceptional dental care to South Extension since 2002.
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Dental Experts Clinic was established with a simple mission: to provide
              world-class dental care in a warm, welcoming environment. Located in the
              heart of South Extension, we've been serving families for over
              15 years.
            </p>
