...
export function VoiceAssistant() {
  ...
  const handleVoiceCommand = (command) => {
    ...
    if (lowerCommand.includes('book') || lowerCommand.includes('appointment')) {
      ...
      responseText = 'Connecting you to Dr. Rajesh Kumar's Dental Clinic. Please hold while I dial the clinic number.'
      setTimeout(() => {
        window.location.href = 'tel:+91-11-43834726'
      }, 2000)
      ...
      responseText = 'We are located at 350, Connaught Place, New Delhi - 11022. Would you like me to open directions in Google Maps?'
    } else if (lowerCommand.includes('price') || lowerCommand.includes('cost')) {
      responseText = 'Our consultation fee is ₹200. For specific treatment costs, I recommend scheduling a consultation with our dentist.'
      ...
      responseText = 'For dental emergencies, please call us immediately at +91-11-43834726. We prioritize emergency cases.'
    } else {
