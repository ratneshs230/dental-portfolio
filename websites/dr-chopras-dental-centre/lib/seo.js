...
export function generateDentalSchema(clinicInfo) {
  return {
    ...
    description: 'Professional dental clinic in Rohini, Delhi offering comprehensive dental care services.',
    ...
    geo: {
      '@type': 'GeoCoordinates',
      latitude: 28.739294508557503,
      longitude: 77.27339820792398
    },
...
export function generateMetaTags(pageInfo) {
  ...
  return {
    ...
    openGraph: {
      ...
      url,
      images: [{ url: image }],
      siteName: 'Dr. Chopra's Dental Centre'
    },
    twitter: {
...
export const locationKeywords = [
  ...
  'teeth cleaning Rohini',
  'root canal Rohini',
  'teeth whitening Rohini',
  'dental clinic delhi',
  'best dental clinic Rohini delhi',
  'affordable dentist Rohini'
]
