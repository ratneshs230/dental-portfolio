...
export function generateDentalSchema(clinicInfo) {
  return {
    ...
    description: 'Professional dental clinic in Najafgarh, Delhi offering comprehensive dental care services.',
    url: typeof window !== 'undefined' ? window.location.origin : '',
    telephone: '+91-11-46528737',
    email: 'info@drdasdentalpractice@gmail.com',
    address: {
      '@type': 'PostalAddress',
    ...
    geo: {
      '@type': 'GeoCoordinates',
      latitude: 28.513109024358943,
      longitude: 77.30558752805663
    },
...
export function generateMetaTags(pageInfo) {
  ...
  return {
    ...
    openGraph: {
      ...
      url,
      images: [{ url: image }],
      siteName: 'Dr. Das Dental Practice'
    },
    twitter: {
...
export const locationKeywords = [
  'dentist Najafgarh',
  'dental clinic Najafgarh',
  'best dentist in Najafgarh',
  'dentist near me Najafgarh',
  'teeth cleaning Najafgarh',
  'root canal Najafgarh',
  'teeth whitening Najafgarh',
  'dental clinic delhi',
  'best dental clinic Najafgarh delhi',
  'affordable dentist Najafgarh'
]
