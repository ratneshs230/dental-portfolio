...
export function generateDentalSchema(clinicInfo) {
  return {
    ...
    description: 'Professional dental clinic in Green Park, Delhi offering comprehensive dental care services.',
    url: typeof window !== 'undefined' ? window.location.origin : '',
    telephone: '+91-11-38094690',
    email: 'info@drsinghsdentalstudio@gmail.com',
    address: {
      '@type': 'PostalAddress',
...
export function generateMetaTags(pageInfo) {
  ...
  return {
    ...
    openGraph: {
      ...
      url,
      images: [{ url: image }],
      siteName: 'Dr. Singh's Dental Studio'
    },
    twitter: {
...
export const locationKeywords = [
  'dentist Green Park',
  'dental clinic Green Park',
  'best dentist in Green Park',
  'dentist near me Green Park',
  'teeth cleaning Green Park',
  'root canal Green Park',
  'teeth whitening Green Park',
  'dental clinic delhi',
  'best dental clinic Green Park delhi',
  'affordable dentist Green Park'
]
