...
export function generateDentalSchema(clinicInfo) {
  return {
    ...
    description: 'Professional dental clinic in Vikaspuri, Delhi offering comprehensive dental care services.',
    url: typeof window !== 'undefined' ? window.location.origin : '',
    telephone: '+91-11-29295987',
    email: 'info@32pearlsdental@gmail.com',
    address: {
      '@type': 'PostalAddress',
    ...
    geo: {
      '@type': 'GeoCoordinates',
      latitude: 28.53990965845208,
      longitude: 77.3631941582899
    },
...
export const locationKeywords = [
  'dentist Vikaspuri',
  'dental clinic Vikaspuri',
  'best dentist in Vikaspuri',
  'dentist near me Vikaspuri',
  'teeth cleaning Vikaspuri',
  'root canal Vikaspuri',
  'teeth whitening Vikaspuri',
  'dental clinic delhi',
  'best dental clinic Vikaspuri delhi',
  'affordable dentist Vikaspuri'
]
