...
export function DentalSchema() {
  const schema = {
    ...
    description: 'Professional dental clinic in Saket, Delhi',
    ...
    geo: {
      '@type': 'GeoCoordinates',
      latitude: 28.595775870988543,
      longitude: 77.03640970953677
    },
...
export function GoogleMapsEmbed() {
  const lat = 28.595775870988543
  const lng = 77.03640970953677
