...
export function generateDentalSchema(clinicInfo) {
  return {
    ...
    description: 'Professional dental clinic in Vasant Kunj, Delhi offering comprehensive dental care services.',
    url: typeof window !== 'undefined' ? window.location.origin : '',
    telephone: '+91-11-24672901',
    email: 'info@drkapoorsdentalclinic@gmail.com',
    address: {
      '@type': 'PostalAddress',
    ...
    geo: {
      '@type': 'GeoCoordinates',
      latitude: 28.479875497066924,
      longitude: 77.09920044106482
    },
...
export function generateMetaTags(pageInfo) {
  ...
  return {
    ...
    openGraph: {
      ...
      url,
      images: [{ url: image }],
      siteName: 'Dr. Kapoor's Dental Clinic'
    },
    twitter: {
...
export const locationKeywords = [
  'dentist Vasant Kunj',
  'dental clinic Vasant Kunj',
  'best dentist in Vasant Kunj',
  'dentist near me Vasant Kunj',
  'teeth cleaning Vasant Kunj',
  'root canal Vasant Kunj',
  'teeth whitening Vasant Kunj',
  'dental clinic delhi',
  'best dental clinic Vasant Kunj delhi',
  'affordable dentist Vasant Kunj'
]
