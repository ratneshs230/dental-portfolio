...
const stats = [
  { icon: Calendar, label: 'Years Experience', value: '9+' },
  { icon: Users, label: 'Happy Patients', value: '2K+' },
  { icon: Award, label: 'Dentists', value: '3' },
  { icon: Heart, label: 'Treatments Done', value: '5076+' },
]
      ...
      <div className="dental-container">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-display font-bold text-dental-foreground mb-6">
            About Dr. Goyal's Dental Practice
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Providing exceptional dental care to Kalkaji since 2015.
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Dr. Goyal's Dental Practice was established with a simple mission: to provide
