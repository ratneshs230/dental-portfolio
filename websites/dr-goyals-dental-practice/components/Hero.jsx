          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-lg">
                Welcome to Dr. Goyal's Dental Practice. Experience exceptional dental care
                in Kalkaji with our team of expert dentists.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href="tel:+91-11-41750446" className="dental-btn-secondary">
              ...
              <div className="aspect-square rounded-3xl bg-dental-gradient p-1">
                <div className="w-full h-full rounded-3xl bg-white flex items-center justify-center">
                  <div className="text-center p-8">
                    ...
                    <div className="text-gray-500">Kalkaji, Delhi</div>
