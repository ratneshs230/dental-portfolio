...
const reviews = [
  {
    ...
    content: 'Excellent dental care! The staff is friendly and professional. My treatment was painless and the results exceeded my expectations.',
    rating: 5
  },
  {
    name: 'Rajesh Kumar',
    role: 'IT Professional',
    content: 'Best dental clinic in the area. Modern equipment and very hygienic environment. Highly recommend for all dental needs.',
    rating: 5
  },
  {
    name: 'Anita Desai',
    role: 'Teacher',
    content: 'Very satisfied with my dental implant treatment. The doctor explained everything clearly and the procedure was smooth.',
    rating: 5
  }
];
