...
export function generateDentalSchema(clinicInfo) {
  return {
    ...
    description: 'Professional dental clinic in South Extension, Delhi offering comprehensive dental care services.',
    url: typeof window !== 'undefined' ? window.location.origin : '',
    telephone: '+91-11-26510051',
    email: 'info@dentalsolutions@gmail.com',
    address: {
      '@type': 'PostalAddress',
    ...
    geo: {
      '@type': 'GeoCoordinates',
      latitude: 28.75393073022317,
      longitude: 77.40162649562178
    },
...
export const locationKeywords = [
  'dentist South Extension',
  'dental clinic South Extension',
  'best dentist in South Extension',
  'dentist near me South Extension',
  'teeth cleaning South Extension',
  'root canal South Extension',
  'teeth whitening South Extension',
  'dental clinic delhi',
  'best dental clinic South Extension delhi',
  'affordable dentist South Extension'
]
