...
const stats = [
  ...
  { icon: Heart, label: 'Treatments Done', value: '2964+' },
]
      ...
      <div className="dental-container">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Providing exceptional dental care to South Extension since 1995.
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Dental Solutions was established with a simple mission: to provide
