...
export function generateDentalSchema(clinicInfo) {
  return {
    ...
    description: 'Professional dental clinic in Pitampura, Delhi offering comprehensive dental care services.',
    url: typeof window !== 'undefined' ? window.location.origin : '',
    telephone: '+91-11-40308358',
    email: 'info@precisiondentalcare@gmail.com',
    address: {
      '@type': 'PostalAddress',
...
export function generateMetaTags(pageInfo) {
  ...
  return {
    ...
    openGraph: {
      ...
      url,
      images: [{ url: image }],
      siteName: 'Precision Dental Care'
    },
    twitter: {
...
export const locationKeywords = [
  'dentist Pitampura',
  'dental clinic Pitampura',
  'best dentist in Pitampura',
  'dentist near me Pitampura',
  'teeth cleaning Pitampura',
  'root canal Pitampura',
  'teeth whitening Pitampura',
  'dental clinic delhi',
  'best dental clinic Pitampura delhi',
  'affordable dentist Pitampura'
]
