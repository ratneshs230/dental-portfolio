...
export function DentalSchema() {
  const schema = {
    ...
    description: 'Professional dental clinic in Pitampura, Delhi',
    ...
    geo: {
      '@type': 'GeoCoordinates',
      latitude: 28.752982349163986,
      longitude: 77.29066524712408
    },
...
export function GoogleMapsEmbed() {
  const lat = 28.752982349163986
  const lng = 77.29066524712408
