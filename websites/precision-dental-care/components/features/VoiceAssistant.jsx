...
export function VoiceAssistant() {
  ...
  const handleVoiceCommand = (command) => {
    ...
    if (lowerCommand.includes('book') || lowerCommand.includes('appointment')) {
      ...
      responseText = 'Connecting you to Precision Dental Care. Please hold while I dial the clinic number.'
      setTimeout(() => {
        window.location.href = 'tel:+91-11-40308358'
      }, 2000)
      ...
      responseText = 'We are located at 464, Pitampura, New Delhi - 11080. Would you like me to open directions in Google Maps?'
      ...
      responseText = 'For dental emergencies, please call us immediately at +91-11-40308358. We prioritize emergency cases.'
    } else {
