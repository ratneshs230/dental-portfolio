...
export function generateDentalSchema(clinicInfo) {
  return {
    ...
    description: 'Professional dental clinic in Defence Colony, Delhi offering comprehensive dental care services.',
    url: typeof window !== 'undefined' ? window.location.origin : '',
    telephone: '+91-11-43304084',
    email: 'info@advancedoralcare@gmail.com',
    address: {
      '@type': 'PostalAddress',
    ...
    geo: {
      '@type': 'GeoCoordinates',
      latitude: 28.436434235335383,
      longitude: 77.25738948352992
    },
...
export const locationKeywords = [
  'dentist Defence Colony',
  'dental clinic Defence Colony',
  'best dentist in Defence Colony',
  'dentist near me Defence Colony',
  'teeth cleaning Defence Colony',
  'root canal Defence Colony',
  'teeth whitening Defence Colony',
  'dental clinic delhi',
  'best dental clinic Defence Colony delhi',
  'affordable dentist Defence Colony'
]
