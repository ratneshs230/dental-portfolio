...
const stats = [
  { icon: Calendar, label: 'Years Experience', value: '29+' },
  { icon: Users, label: 'Happy Patients', value: '2K+' },
  { icon: Award, label: 'Dentists', value: '1' },
  { icon: Heart, label: 'Treatments Done', value: '3240+' },
]
      ...
      <div className="dental-container">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-display font-bold text-dental-foreground mb-6">
            About Dr. Anjali Mehta's Dental Clinic
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Providing exceptional dental care to Shalimar Bagh since 2001.
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Dr. Anjali Mehta's Dental Clinic was established with a simple mission: to provide
              world-class dental care in a warm, welcoming environment. Located in the
              heart of Shalimar Bagh, we've been serving families for over
              29 years.
            </p>
            <p className="text-gray-600 mb-6">
              Our team of 1 experienced dentist and
              5 support staff are committed to making every visit comfortable
              and stress-free.
            </p>
          ...
          >
            ...
            <div className="relative dental-card">
              ...
              <ul className="space-y-2 text-gray-600">
                <li>• Modern 2-chair dental setup</li>
                <li>• Both sterilization</li>
