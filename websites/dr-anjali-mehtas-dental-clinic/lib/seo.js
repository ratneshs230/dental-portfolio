...
export function generateDentalSchema(clinicInfo) {
  return {
    ...
    description: 'Professional dental clinic in Shalimar Bagh, Delhi offering comprehensive dental care services.',
    url: typeof window !== 'undefined' ? window.location.origin : '',
    telephone: '+91-11-21654426',
    email: 'info@dranjalimehtasdentalclinic@gmail.com',
    address: {
      '@type': 'PostalAddress',
...
export function generateMetaTags(pageInfo) {
  ...
  return {
    ...
    openGraph: {
      ...
      url,
      images: [{ url: image }],
      siteName: 'Dr. Anjali Mehta's Dental Clinic'
    },
    twitter: {
...
export const locationKeywords = [
  'dentist Shalimar Bagh',
  'dental clinic Shalimar Bagh',
  'best dentist in Shalimar Bagh',
  'dentist near me Shalimar Bagh',
  'teeth cleaning Shalimar Bagh',
  'root canal Shalimar Bagh',
  'teeth whitening Shalimar Bagh',
  'dental clinic delhi',
  'best dental clinic Shalimar Bagh delhi',
  'affordable dentist Shalimar Bagh'
]
