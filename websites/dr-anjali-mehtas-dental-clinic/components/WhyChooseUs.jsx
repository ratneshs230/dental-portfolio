...
const reasons = [
  ...
  },
  {
    icon: Users,
    title: 'Expert Team',
    description: '1 qualified dentist with specialized training'
  },
  {
    icon: Sparkles,
      ...
      <div className="dental-container px-4">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Discover what makes Dr. Anjali Mehta's Dental Clinic the preferred choice for dental care in Shalimar Bagh.
          </p>
        </motion.div>
