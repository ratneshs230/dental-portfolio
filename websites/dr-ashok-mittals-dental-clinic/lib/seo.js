...
export function generateDentalSchema(clinicInfo) {
  return {
    ...
    description: 'Professional dental clinic in Kalkaji, Delhi offering comprehensive dental care services.',
    url: typeof window !== 'undefined' ? window.location.origin : '',
    telephone: '+91-11-21357370',
    email: 'info@drashokmittalsdentalclinic@gmail.com',
    address: {
      '@type': 'PostalAddress',
...
export function generateMetaTags(pageInfo) {
  ...
  return {
    ...
    openGraph: {
      ...
      url,
      images: [{ url: image }],
      siteName: 'Dr. Ashok Mittal's Dental Clinic'
    },
    twitter: {
...
export const locationKeywords = [
  ...
  'best dentist in Kalkaji',
  'dentist near me Kalkaji',
  'teeth cleaning Kalkaji',
  'root canal Kalkaji',
  'teeth whitening Kalkaji',
  'dental clinic delhi',
  'best dental clinic Kalkaji delhi',
  'affordable dentist Kalkaji'
]
