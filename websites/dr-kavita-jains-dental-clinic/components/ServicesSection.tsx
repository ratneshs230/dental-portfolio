...
const services = [
  ...
  },
  {
    icon: '02',
    title: 'Orthodontics',
    description: 'Invisible aligners and modern braces for perfect teeth alignment with comfort.',
    borderColor: 'from-emerald-400 via-cyan-500 to-blue-500'
  },
  {
    icon: '03',
    title: 'Dental Crowns',
    description: 'Custom-made crowns to restore damaged teeth and improve your smile aesthetics.',
    borderColor: 'from-orange-400 via-pink-500 to-purple-500'
  },
  {
    icon: '04',
    title: 'Gum Treatment',
    description: 'Comprehensive periodontal care to maintain healthy gums and prevent disease.',
    ...
    <section id="services" className="bg-white py-24 px-6 md:px-12">
      <style>{`
        ...
        .service-card::before {
          ...
          padding: 2px;
          background: linear-gradient(135deg, transparent 40%, 236, 72, 153,0.3) 50%, transparent 60%);
        ...
        .corner-accents::after {
          ...
          border-radius: 1.5rem;
          background:
            linear-gradient(135deg, 236, 72, 153,0.5) 0%, transparent 20%) top left,
            linear-gradient(-135deg, 236, 72, 153,0.5) 0%, transparent 20%) top right,
            linear-gradient(45deg, 236, 72, 153,0.5) 0%, transparent 20%) bottom left,
            linear-gradient(-45deg, 236, 72, 153,0.5) 0%, transparent 20%) bottom right;
