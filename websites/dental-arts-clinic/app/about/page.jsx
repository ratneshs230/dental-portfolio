...
const stats = [
  { icon: Calendar, label: 'Years Experience', value: '11+' },
  { icon: Users, label: 'Happy Patients', value: '3K+' },
  { icon: Award, label: 'Dentists', value: '2' },
  { icon: Heart, label: 'Treatments Done', value: '3876+' },
]
      ...
      <div className="dental-container">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-display font-bold text-dental-foreground mb-6">
            About Dental Arts Clinic
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Providing exceptional dental care to Mayur Vihar since 2000.
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Dental Arts Clinic was established with a simple mission: to provide
