...
const stats = [
  ...
  { icon: Heart, label: 'Treatments Done', value: '1668+' },
]
      ...
      <div className="dental-container">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Providing exceptional dental care to Greater Kailash since 2013.
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <p className="text-gray-600 mb-4">
              Family Dental Care was established with a simple mission: to provide
              world-class dental care in a warm, welcoming environment. Located in the
              heart of Greater Kailash, we've been serving families for over
              12 years.
            </p>
