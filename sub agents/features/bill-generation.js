...
export class BillGenerationFeature {
  async integrate(outputPath, clinicInfo) {
    ...
    await fs.writeFile(path.join(featuresDir, 'BillGenerator.jsx'), `'use client'
      ...
      <div className="dental-card" ref={billRef}>
        ...
        <div className="flex justify-between items-start mb-8 pb-6 border-b border-gray-200">
          <div>
            ...
            <p className="text-gray-600 mt-1">${clinicInfo.address}</p>
            <p className="text-gray-600">Phone: ${clinicInfo.phones[0] || ''}</p>
          </div>
...
`);
    ...
    // Billing Library
    await fs.writeFile(path.join(libDir, 'billing.js'), `/**
...
export default BillGenerationFeature;
