...
const reviews = [
  {
    name: 'Amit Patel',
    role: 'Entrepreneur',
    content: 'Outstanding service! Dr. Sanjeev Bhatia's Dental Clinic uses latest technology and the team is highly skilled. My smile has never looked better.',
    rating: 5
  },
  {
    name: 'Meera Reddy',
        ...
        <div className="relative">
          ...
          <div className="review-card-wrapper max-w-4xl mx-auto">
            <div className="review-card-inner p-10 md:p-14">
              {/* Quote Icon */}
              <svg className="w-12 h-12 text-indigo-200 mb-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {reviews.map((_, index) => (
                    <button
                      ...
                      className={`w-3 h-3 rounded-full transition-all duration-300 ${
                        index === activeIndex
                          ? 'bg-indigo-500 w-8 shadow-lg shadow-indigo-500/50'
