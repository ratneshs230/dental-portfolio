      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <p className="text-gray-400 text-lg leading-relaxed mb-12">
              Ready to transform your smile? Contact Excel Dental Centre today to schedule your consultation or speak with our AI assistant for immediate assistance.
            </p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-gray-500">+91-11-27288772</p>
                </div>
              </div>
        ...
        <div className="mt-20 pt-8 border-t border-gray-800 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-600 text-sm">
            © 2024 Excel Dental Centre. All rights reserved.
          </p>
