...
const reviews = [
  {
    name: 'Amit Patel',
    role: 'Entrepreneur',
    content: 'Outstanding service! Dr. Kavita Jain's Dental Clinic uses latest technology and the team is highly skilled. My smile has never looked better.',
    rating: 5
  },
  {
    name: 'Meera Reddy',
        ...
        <div className="relative">
          ...
          <div className="review-card-wrapper max-w-4xl mx-auto">
            <div className="review-card-inner p-10 md:p-14">
              {/* Quote Icon */}
              <svg className="w-12 h-12 text-pink-200 mb-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {reviews.map((_, index) => (
                    <button
                      ...
                      className={`w-3 h-3 rounded-full transition-all duration-300 ${
                        index === activeIndex
                          ? 'bg-pink-500 w-8 shadow-lg shadow-pink-500/50'
