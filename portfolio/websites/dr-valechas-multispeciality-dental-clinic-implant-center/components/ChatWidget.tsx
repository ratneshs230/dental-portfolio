      ...
      {isOpen && (
        <div className="mb-4 w-80 sm:w-96 bg-white border border-gray-200 shadow-2xl rounded-lg overflow-hidden flex flex-col h-[500px]">
          <div className="bg-black text-white p-4 flex justify-between items-center">
            <h3 className="font-serif italic tracking-wide">Riya - Dr. Valecha's Multispeciality Dental Clinic & Implant Center</h3>
          ...
          <div className="flex-1 overflow-y-auto p-4 bg-gray-50 space-y-4">
            {messages.length === 0 && (
              <div className="text-center text-gray-400 mt-20 text-sm">
                <p>Welcome to Dr. Valecha's Multispeciality Dental Clinic & Implant Center.</p>
